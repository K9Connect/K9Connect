...
public interface DogRepository extends JpaRepository<Dog, Long> {
    ...
    List<Dog>  findDogsByIdAndBreedAndGenderAndNameAndPhotosAndReviewsOrderById(long id, String breed, char gender, String name, List<Photo> photos, List<DogReview> reviews);
